...
source /workspaces/tur_ws_cont/install/setup.bash
...
export GZ_SIM_RESOURCE_PATH=/workspaces/tur_ws_cont/src/bluerov2_ignition/models:/workspaces/tur_ws_cont/src/bluerov2_ignition/worlds:$GZ_SIM_RESOURCE_PATH

# Add orca4 models and worlds
export GZ_SIM_RESOURCE_PATH=/workspaces/tur_ws_cont/src/multiple_orca/models:/workspaces/tur_ws_cont/src/multiple_orca/worlds:$GZ_SIM_RESOURCE_PATH
