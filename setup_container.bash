...
source /workspaces/tur_ws/install/setup.bash
...
export GZ_SIM_RESOURCE_PATH=/workspaces/tur_ws/src/bluerov2_ignition/models:/workspaces/tur_ws/src/bluerov2_ignition/worlds:$GZ_SIM_RESOURCE_PATH

# Add orca4 models and worlds
export GZ_SIM_RESOURCE_PATH=/workspaces/tur_ws/src/multiple_orca/models:/workspaces/tur_ws/src/multiple_orca/worlds:$GZ_SIM_RESOURCE_PATH
